...
/// <summary>
/// A measurable attribute that defines an entitys behaviour in-simulation.
/// <br/>Stats' numerical values are calculated purely at runtime based on the state of various other systems (i.e. skills).
/// </summary>
public class Stat
{
    /// <summary>
